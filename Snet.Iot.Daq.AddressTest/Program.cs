...
{
    list_dbw.Add(new BytesModel($"DB5.DBW{i}", "0-398数据", i, 2, Snet.Model.@enum.DataType.Int16, Snet.Model.@enum.DataFormat.ABCD));
}
...
{
    list_dbd_int_1.Add(new BytesModel($"DB5.DBD{i}", "400-796数据", startBit, 4, Snet.Model.@enum.DataType.Int, Snet.Model.@enum.DataFormat.ABCD));
    startBit += 4;
}
...
{
    list_dbd_int_2.Add(new BytesModel($"DB5.DBD{i}", "800-1196数据", startBit, 4, Snet.Model.@enum.DataType.Int, Snet.Model.@enum.DataFormat.ABCD));
    startBit += 4;
...
{
    list_dbd_float.Add(new BytesModel($"DB5.DBD{i}", "1200-1596数据", startBit, 4, Snet.Model.@enum.DataType.Float, Snet.Model.@enum.DataFormat.ABCD));
    startBit += 4;
}
